...
<div class="box550a25">
<span style="float:left;width:30px;margin-left:8px;"><a class="editHref" href=<?php echo U('__APP__/Boss/editpost',array('cid'=>$vo['id']));?>>编辑</a></span>
<span style="width:30px;float:left;margin-left:8px;text-align:center;display:none;"><a id="deleteHref"  href=<?php echo U('__APP__/Boss/delpost',array('cid'=>$vo['id']));?>>删除</a></span>
</div>
</div>
