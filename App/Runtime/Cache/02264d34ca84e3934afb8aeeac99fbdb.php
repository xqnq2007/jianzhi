...
<ul class="formul">
	...
	<input type="checkbox" id="zhaopin"name="tongyi" value="0" checked=true />&nbsp;招聘消息&nbsp;&nbsp;<input type="checkbox" id="qiuzhi" name="tongyi" value="1"/>&nbsp;求职消息</li>
	...
	<li class="formli" name="yzcodeLi"><span class="test" ><font  class="mar_rig5 red">*</font>验证码</span><span class="mar_rig10">:</span> <img class="yzimg" id="yzcodeImg" name="Image1" title="验证码" src='__APP__/Post/yanzhengma'><a href="javascript:fleshVerify();">换一个</a></li>
	...
	<li class="formli" name="agreementLi"id="agreementLi"><input type="checkbox" name="tongyi" value="1" checked="checked" />我同意兼职网服务条款《<a href="__APP__/Public/agreement">使用协议</a>》 </li>
