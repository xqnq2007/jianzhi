...
<div id="stubigmain">
<div id="stumain"><div class="divvolist"><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="box600a205">
<div class="box600a50">
<div class="box450a50"><a href="<?php echo U('__APP__/Post/stuPostDetail',array('cid'=>$vo['id']));?>"><font class="title"><?php echo ($vo["title"]); ?></font></a></div>
